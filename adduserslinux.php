					...
					<div class="content-module-main cf">
                                            ...
                                            <div class="half-size-column fr">
                                                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                    <label for="textarea">Check Linux User </label>
                                                    <input type="text" id="simple-input" name="username" class="round default-width-input" />
                                                    <input type="submit" name="btnCheck" id="btnCheck" class="button round blue image-right ic-search text-upper" value="Check"/>
                                                </form>
                                                <br>
                                                <?php
