				...
				<div class="content-module">
					...
					<div class="content-module-main cf">
                                            <div class="half-size-column fl">
                                                ...
                                                <label for="simple-input">Add Web User</label
                                                
                                                <table>
                                                    <tr>
                                                        <td>Username</td>
                                                        <td><input type="text" id="simple-input" name="txtUsername" class="round default-width-input" /> <br></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td>
                                                        <td><input type="text" id="simple-input" name="txtEmail" class="round default-width-input" /> <br> <br></td>
                                                    </tr>
                                                </table>
                                                ...
                                                <input type="submit" name="btnAddUser" id="btnAddUser" class="button round blue image-right ic-add text-upper" value="Add"/>
                                                </form>
                                                <?php 
